...
require('lazy').setup({
    ...
    config = function()
      ...
      vim.api.nvim_create_autocmd('LspAttach', {
        ...
        callback = function(event)
          ...
          -- Enable inline diagnostics (virtual text) when LSP is attached
      ...
      -- Collect everything that should be installed
  ...
  { -- Highlight, edit, and navigate code
    ...
    config = function(_, opts)
      ...
      -- NOTE: The new nvim-treesitter only accepts `install_dir` in setup().
      -- Highlighting and indent are now handled by Neovim's built-in treesitter.
